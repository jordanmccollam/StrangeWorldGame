...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_eventName":"PersonalPlan-Cancel",
      "vtp_measurementId":"G-7YMFEFLR6Q",
      "vtp_enableUserProperties":true,
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003E(function(){var a=document.body.getAttribute(\"data-clp-course-id\");a\u0026\u0026!",["escape",["macro",29],8,16],"\u0026\u0026fbq(\"track\",\"ViewContent\",{content_ids:a,content_type:\"product\",course_avg_rating:",["escape",["macro",30],8,16],",course_category:",["escape",["macro",31],8,16],",course_instructor_name:",["escape",["macro",32],8,16],",course_language:",["escape",["macro",25],8,16],",course_length_minutes:",["escape",["macro",33],8,16],",course_locale:",["escape",["macro",34],8,16],",course_num_enrollments:",["escape",["macro",35],8,16],",course_subcategory:",["escape",["macro",36],8,16],",course_topic:",["escape",["macro",37],8,16],",\nuser_language:",["escape",["macro",26],8,16],",user_locale:",["escape",["macro",38],8,16],",user_location:",["escape",["macro",27],8,16],",has_made_paid_purchase:",["escape",["macro",28],8,16],"})})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "setup_tags":["list",["tag",1,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003EUD.GoogleAnalytics.setValue(\"dimension7\",\"true\");UD.GoogleAnalytics.trackEvent(\"ismember\",\"ismember\",\"ismember\",void 0,void 0,{nonInteraction:1});",["escape",["macro",29],8,16],"||fbq(\"trackCustom\",\"isMember\");\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "setup_tags":["list",["tag",1,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003E(function(){var b=document.body.getAttribute(\"data-clp-course-id\")||\"NA\",a=document.querySelector('[data-purpose\\x3d\"course-price-text\"]');a=a?a.textContent.replace(\"$\",\"\").trim().match(\/\\d+(?:\\.\\d+)?\/):null;void 0!==UD.GoogleAnalytics\u0026\u0026(UD.GoogleAnalytics.setValue(\"dimension5\",b),UD.GoogleAnalytics.setValue(\"dimension6\",\"conversionintent\"),UD.GoogleAnalytics.setValue(\"dimension8\",a[0]),UD.GoogleAnalytics.trackEvent(\"addtocartclick\",b,a[0],{nonInteraction:1}));",["escape",["macro",29],8,16],"||fbq(\"track\",\"AddToCart\",\n{content_name:\"Shopping Cart\",content_ids:b,content_type:\"product\"})})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
  ...
  "predicates":[{
      ...
      "function":"_css",
      "arg0":["macro",24],
      "arg1":"[data-purpose=\"modal-cancel-subscription\"] \u003E span"
    },{
      "function":"_css",
      "arg0":["macro",24],
      "arg1":"[data-purpose=\"modal-cancel-subscription\"]"
    },{
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"\/subscription-checkout\/express\/success\/"
    },{
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"udemy.com"
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",3,73]],
    [["if",6,7],["add",4,8,9,10,15,20,21,25,28,29,30,32,35,37,40,42,44,69,89,90,95,96,102,105,108,118,123]],
    [["if",4,5],["add",5],["block",3,7,17,36,38,41,76,1,81,86,87,91,2,97,98,100,103,106]],
    [["if",5],["add",5,17,45,46,81,103,106,117,122,125,50,51,53,54,55,59,62,63,67,68,71,74,75]],
    [["if",5,9],["unless",8],["add",6,16]],
    [["if",10,11],["add",7]],
    [["if",5,12],["add",11,84]],
    [["if",13,14,15],["add",12,85]],
    [["if",6,7,16],["add",13]],
    [["if",5,17],["add",14,24,27]],
    [["if",5,18],["add",16]],
    [["if",5,19],["add",16]],
    [["if",5,20],["add",16],["block",86]],
    [["if",5,18,21],["add",16]],
    [["if",5,22],["add",16]],
    [["if",5,23],["add",16]],
    [["if",5,24],["add",16]],
    [["if",5,25],["add",16]],
    [["if",5,26],["add",16]],
    [["if",15,31],["add",18,32,34,79,94]],
    [["if",15,32],["add",19]],
    [["if",5,33],["add",22]],
    [["if",34],["add",23]],
    [["if",5,35],["add",26,32,33,37,39,43,82,93,101,104,107,119,124]],
    [["if",5,36],["add",31]],
    [["if",5,37],["add",31]],
    [["if",5,38],["add",31]],
    [["if",0,5,16],["add",36,38,87,97,100]],
    [["if",0,5],["unless",1,39],["add",41,61,86,91,0]],
    [["if",15,40],["add",47,48,121]],
    [["if",15,41],["add",47,48,121]],
    [["if",5,42],["add",49,120]],
    [["if",5,43],["add",52]],
    [["if",45],["unless",44],["add",56,64]],
    [["if",3],["unless",46],["add",57,65]],
    [["if",3],["add",58,66]],
    [["if",3,47],["add",60]],
    [["if",3,48],["add",70]],
    [["if",3,49],["add",72]],
    [["if",5,27],["add",76],["block",17,86,92,99,103,106]],
    [["if",5,50],["unless",51],["add",76]],
    [["if",52,53],["add",76]],
    [["if",5,55],["add",1]],
    [["if",57,58],["add",77]],
    [["if",3,59],["add",78]],
    [["if",60,61],["add",80]],
    [["if",6,62],["add",83]],
    [["if",65,66,67,68],["add",88]],
    [["if",66,68],["add",92]],
    [["if",57,69],["add",2]],
    [["if",57,70],["add",98]],
    [["if",57,71],["add",99]],
    [["if",5,72],["add",109,110,111]],
    [["if",6,7,72],["add",111]],
    [["if",3,59,72],["add",112]],
    [["if",15,31,72],["add",113]],
    [["if",57,72,73],["add",114]],
    [["if",13,14,15,72],["add",115]],
    [["if",5,35,72],["add",116]],
    [["if",5,28],["block",17,86,92,99,103,106]],
    [["if",5,29],["block",17,86,92,99,103,106]],
    [["if",5,30],["block",17,86,92,99,103,106]],
    [["if",5,39],["block",76,1]],
    [["if",5,54],["block",76]],
    [["if",5,56],["block",1]],
    [["if",5,63],["block",86]],
...
var Sg=[L.C,L.F],Tg=function(a){var b=a[L.md];b&&Cf(40);var c=a[L.Fe];c&&Cf(41);for(var d=Na(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==L.md&&f!==L.Fe)if(-1<Pa(Sg,f)){var g=f,h=a[f],l=d[e];xg().set(g,h,l,"US","US-GA",c)}else{}},Ug=function(a,
...
W.h.ga=["google"],function(){var a,b;(function(c){W.__ga=c;W.__ga.i="ga";W.__ga.m=!0;W.__ga.priorityOverride=0})(function(c){function d(U){var P=[].slice.call(arguments,0);P[0]=u+P[0];r.push(P)}function e(U,P){void 0!==c[P]&&d(U,c[P])}function f(U,P){void 0!==c[P]&&d(U,Number(c[P]))}function g(U,P){if(q(P))for(var Y=0;Y<P.length;Y++)d(U,P[Y])}function h(U,P,Y){if(q(P))for(var ha=0;ha<P.length;ha++){for(var pa=[U],Fa=P[ha],Ga=
0;Ga<Y.length;Ga++)pa.push(Fa[Y[Ga]]);d.apply(this,pa)}}function l(U,P){void 0!==c[P]&&d("_set",U,c[P])}function m(U,P){return void 0===P?P:U(P)}function n(U,P){void 0!==P&&(v+="&"+U+"="+P)}var q=Na,r=T("_gaq",[],!1),t=!1,u="";void 0==c.vtp_trackerName?u="gtm"+ei()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",Qm(!0));
e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
g("_addIgnoredRef",c.vtp_ignoredRef);g("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var x=function(U,P,Y){for(var ha=P.length-1;0<=ha;ha--){var pa=P[ha].split("=");if(pa[0]===U)return pa[1]||"1"}for(var Fa=Y.length-1;0<=Fa;Fa--){var Ga=Y[Fa].split("=");if(Ga[0]===U)return Ga[1]||"1"}},z=th(ns()),w=rh(z,"query").split("&"),y=c.vtp_allowAnchor?rh(z,"fragment").split("&"):[];n("gclid",x("gclid",y,w));n("gclsrc",x("gclsrc",y,w));n("dclid",x("dclid",y,w));d("_set",
...
t=!!c.vtp_forceSsl);d("_set","hitCallback",function(){La(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});
...
g("_cookiePathCopy",c.vtp_cookiePathCopy);var X=function(){T("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,R(Fk("https","http","://stats.g.doubleclick.net/dc.js",t),X,c.vtp_gtmOnFailure));else if(!a){var la=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;R(Fk("https://ssl","http://www",la,t),X,c.vtp_gtmOnFailure)}})}();
